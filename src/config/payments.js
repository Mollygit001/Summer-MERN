...
// Subscription Plan Identifiers and Metadata
export const PLAN_IDS = {
  UNLIMITED_YEARLY: {
    id: 'plan_Qq3BLlg9F6OSCx',
    planName: 'Unlimited Yearly',
    description: 'Yearly subscription, 2 months free',
    totalBillingCycleCount: 5, // e.g. 12 months charged for 10
  },
  UNLIMITED_MONTHLY: {
    id: 'plan_Qq35GWOqgIh6hr',
